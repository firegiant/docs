...
Top-level elements like [Product](/wix3/xsd/wix/product/), [Module](/wix3/xsd/wix/module/), [Patch](/wix3/xsd/wix/patch/), and [PatchCreation](/wix3/xsd/wix/patchcreation/) support a Codepage attribute. You can set this to a valid Windows code page by integer like 1252, or by web name like Windows-1252. UTF-7 and UTF-8 are not officially supported because of user interface issues. Unicode is not supported.

To support authoring a single package that can be localized into multiple languages, you can set the [Package](/wix3/xsd/wix/package/)/@SummaryCodepage or [PatchInformation](/wix3/xsd/wix/patchinformation/)/@SummaryCodepage element to an localization expression like !(loc.SummaryCodepage). You then define the SummaryCodepage value in a [localization file](/wix3/howtos/ui_and_localization/make_installer_localizable/), typically ending in a .wxl extension. The root WixLocalization element also supports a Codepage attribute that is used to encode the rest of the package database.
...
For a walkthrough about how to author a build localized packages using WiX see [How To: Make your installer localizable](/wix3/howtos/ui_and_localization/make_installer_localizable/) and [How To: Build a localized version of your installer](/wix3/howtos/ui_and_localization/build_a_localized_version/).
