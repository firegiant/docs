...
To get started using standard custom actions, see the [Using Standard Custom Actions](/wix3/customactions/using_standard_customactions/) topic.

For information about specific types of standard custom actions, see the following topics:

* [FileShare custom action](/wix3/xsd/util/fileshare/) (located in WixUtilExtension) - create and configure file shares.
* [Internet shortcut custom action](/wix3/xsd/util/internetshortcut/) (located in WixUtilExtension) - create shortcuts that point to Web sites.
...
* [Secure Objects custom action](/wix3/xsd/util/permissionex/) (located in WixUtilExtension) - secure (using ACLs) objects that the <a href='http://msdn.microsoft.com/library/aa369774.aspx' target="_blank">LockPermissions table</a> cannot.
* [Service Configuration custom action](/wix3/xsd/util/serviceconfig/) (located in WixUtilExtension) - configure attributes of a Windows service that the <a href='http://msdn.microsoft.com/library/aa371637.aspx' target="_blank">ServiceInstall table</a> cannot.
* [ShellExecute custom action](shellexec/) (located in WixUtilExtension) - launch document or URL targets via the Windows shell.
* [User custom actions](/wix3/xsd/util/user/) (located in WixUtilExtension) - create and configure new users.
...
* [WixFirewallExtension](/wix3/xsd/firewall/) - Firewall custom action that can be used to add exceptions to the Windows Firewall.
...
* [WixIIsExtension](/wix3/xsd/iis/) - Internet Information Services (IIS) custom actions that can be used to create and configure web sites, virtual directories, web applications, etc.
...
* [WixSqlExtension](/wix3/xsd/sql/) - SQL Server custom actions that can be used to create databases and execute SQL scripts and statements.
...
* [XmlFile custom action](/wix3/xsd/util/xmlfile/) (located in WixUtilExtension) - configure and modify XML files as part of your installation package.
