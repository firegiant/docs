...
For a step-by-step example of how to use the ShellExecute custom action to launch a program at the end of install see the [How To: Run the Installed Application After Setup](/wix3/howtos/ui_and_localization/run_program_after_install/) topic.
