...
To use these custom actions you simply need to add a [PropertyRef](/wix3/xsd/wix/propertyref/) to the property you want to use and then include WixUtilExtensions when linking. For example:
