...
<BlockWrapper>
  ...
  <BlockReference
    content={{
      title: "DisplayFilesInUseDialogCondition, from extension namespace http://wixtoolset.org/schemas/v4/wxs/bal",
      type: "string"
    }}
  >
