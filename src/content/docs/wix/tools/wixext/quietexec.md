...
[As noted in _Frequently-asked questions about upgrading from WiX v3 to WiX v4_](/wix/whatsnew/faqs/#customactionids), some extra effort is sometimes required due to WiX v4's support for architecture-specific custom actions. That effort for WixQuietExec and friends is a little bit different:
